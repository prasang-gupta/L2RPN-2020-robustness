...
from grid2op.Reward import L2RPNReward ,LinesReconnectedReward
...
class A3CAgent:
    def __init__(self, state_size, action_size):
        ...
        self.threads = 4 # 48 or 16 or 32 - corresponds to parallel agents
    ...
    def save_model(self, name):
        self.actor.save_weights(name + "_backup1_actor.h5")
        self.critic.save_weights(name + "_backup1_critic.h5")

    def load_model(self, name):
        self.actor.load_weights(name + "_backup1_actor.h5")
        self.critic.load_weights(name + "_backup1_critic.h5")
...
class Agent(threading.Thread):
    ...
    def run(self):
        ...
        env = grid2op.make("l2rpn_wcci_2020", reward_class=LinesReconnectedReward, difficulty="competition")
